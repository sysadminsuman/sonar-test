import { userService, pushNotificationService } from "../../services/index.js";
...
export const agreement = async (req, res, next) => {
  try {
    ...
    if (P07 === true || P07 === false) {
      ...
      pushNotificationService.sendBadgeCountNotification(notificationSilentUserIds, "BATCH_COUNT", {
        badgeSilentNumbers,
      });
    }
