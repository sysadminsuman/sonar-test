import { v850Service } from "../../../services/index.js";
...
export const getUserAllChatrooms = async (req, res, next) => {
  try {
    ...
    const allChatrooms = await v850Service.chatService.getCountUserAllChatrooms(userDetails.userId);
    ...
    if (totalChatrooms > 0) {
      ...
      const lastMessageID = reqQuery.last_message_id ? parseInt(reqQuery.last_message_id) : 0;
      ...
      const userChatrooms = await v850Service.chatService.getUserChatroomsByPagination(
        userDetails.userId,
        offSet,
        noOfRecordsPerPage,
        lastMessageID,
