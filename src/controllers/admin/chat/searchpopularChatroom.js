 ...
 * @param next
 */
export const searchpopularChatroom = async (req, res, next) => {
  try {
    ...
    // search parameter
    const userChatrooms = await adminService.chatService.searchpopularChatrooms(
      searchParams,
      //userDetails.userId,
      offSet,
      noOfRecordsPerPage,
    );
    const totalChatrooms = userChatrooms.length;
