import { v2Service } from "../../../services/index.js";
...
export const getUserAllChatrooms = async (req, res, next) => {
  try {
    ...
    const allChatrooms = await v2Service.chatService.getCountUserAllChatrooms(userDetails.userId);
    ...
    if (totalChatrooms > 0) {
      ...
      const userChatrooms = await v2Service.chatService.getUserChatroomsByPagination(
        userDetails.userId,
        offSet,
        noOfRecordsPerPage,
        lastMessageID,
