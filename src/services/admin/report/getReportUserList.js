...
export const getReportUserList = async (searchParams = {}) => {
  let params = [];
  let whereQuery = " 1=1 ";
  ...
  FROM ${TABLES.CHATROOM_MEMBER_REPORTINGS_TABLE} AS mr ${memberstbl} ${crtbl} ${mtutbl} WHERE ${whereQuery} ORDER BY mr.id DESC `;
