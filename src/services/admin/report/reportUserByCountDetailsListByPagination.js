...
export const reportUserByCountDetailsListByPagination = async (
  offSet,
  limit,
  searchParams = {},
  getId,
  ...
  FROM ${TABLES.CHATROOM_MEMBER_REPORTINGS_TABLE} AS mr ${memberstbl}${mtutbl} ${crtbl} WHERE  ${whereQuery}  GROUP BY mr.user_id,mr.room_id,mr.type,mr.description, mr.create_date  ORDER BY mr.id DESC LIMIT ?, ?`;
  //console.log(query);
